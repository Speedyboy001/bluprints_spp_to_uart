...
C_SRCS += \
../tlkmmi/test/usr/tlkmmi_usr.c \
../tlkmmi/test/usr/tlkmmi_usrMsg.c \
../tlkmmi/test/usr/tlkmmi_usrShell.c 

OBJS += \
./tlkmmi/test/usr/tlkmmi_usr.o \
./tlkmmi/test/usr/tlkmmi_usrMsg.o \
./tlkmmi/test/usr/tlkmmi_usrShell.o 

C_DEPS += \
./tlkmmi/test/usr/tlkmmi_usr.d \
./tlkmmi/test/usr/tlkmmi_usrMsg.d \
./tlkmmi/test/usr/tlkmmi_usrShell.d 


# Each subdirectory must supply rules for building sources it contributes
tlkmmi/test/usr/%.o: ../tlkmmi/test/usr/%.c tlkmmi/test/usr/subdir.mk
	@echo 'Building file: $<'
