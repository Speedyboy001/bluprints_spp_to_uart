...
/**
 * @brief    Set spp flow control mode.
 * @param[in] isEnable 1: enable spp flow control,stop receive spp data. 0: disable spp flow control, continue receive spp data.
 * @returns none.
*/
void tlkbt_hci_setC2hSppFlowCtrl(uint8_t isEnable);
uint8_t tlkbt_hci_getC2hSppFlowCtrl(void);
