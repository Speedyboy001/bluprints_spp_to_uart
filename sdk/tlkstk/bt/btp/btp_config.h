...
#define TLKBTP_CFG_IAP_ENABLE            (0 && TLK_STK_BTP_ENABLE)
...
#define TLKBTP_CFG_HIDD_ENABLE           (0 && TLKBTP_CFG_HID_ENABLE)
#define TLKBTP_CFG_HIDH_ENABLE           (0 && TLKBTP_CFG_HID_ENABLE)
#define TLKBTP_CFG_PTSL2C_ENABLE         (0 && TLK_CFG_TEST_ENABLE)
