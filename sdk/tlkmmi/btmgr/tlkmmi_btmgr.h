...
#define TLKMMI_BTMGR_MAJOR_DEVICE_CLASS		(BTH_COD_MAJOR_CLASS_IMAGING)
#define TLKMMI_BTMGR_MINOR_DEVICE_CLASS		(BTH_COD_IMAGING_PRINTER)
...
/******************************************************************************
 * Function: tlkmmi_btmgr_updatePairingMode
 * Descript: Update pairing mode configuration based on legacy PIN flag.
 * Params: None.
 * Return: None.
 * Others: None.
*******************************************************************************/
extern void tlkmmi_btmgr_updatePairingMode(void);
