...
//dev
//extern uint08 bt_addr[6];
//static int tlkmdi_btacl_pincodeEvt(uint08 *pData, uint16 dataLen);
//
...
//	bth_event_regCB(BTH_EVTID_PINCODE_REQUEST, tlkmdi_btacl_pincodeEvt);
	return TLK_ENONE;
}
...
//bth_event_regCB(BTH_EVTID_PINCODE_REQUEST, tlkmdi_btacl_pincodeEvt);
//
//// Uncomment and fix the handler function:
//static int tlkmdi_btacl_pincodeEvt(uint08 *pData, uint16 dataLen)
//{
//    bth_pinCodeRequestEvt_t *pEvt;
//    pEvt = (bth_pinCodeRequestEvt_t*)pData;
//
//    // Use your set MAC address (bt_addr) instead of dev_addr
//    uint08 *dev_addr = (uint08*)tlkmmi_btmgr_getAddr();
//
//    // Debug: Show which MAC is being used
//    uint08 buff[128];
//    int x = sprintf(buff,"EVTMAC=%02x:%02x:%02x:%02x:%02x:%02x\n\r",
//        dev_addr[0],dev_addr[1],dev_addr[2],dev_addr[3],dev_addr[4],dev_addr[5]);
//    uart_send(UART1, buff, x);
//
//    // Use your PIN code from fc_hw_flag
//    if (fc_hw_flag.pin_en_flag) {
//        bth_hci_sendPinCodeReqReplyCmd(dev_addr, fc_hw_flag.pincode, fc_hw_flag.pinlen);
//    } else {
//        bth_hci_sendPinCodeReqNegReplyCmd(dev_addr);
//    }
//
//    uart_send(UART1, (uint08*)"PIN_REQUEST FUNCTION\r\n", 22);
//    return TLK_ENONE;
//}
