...
#define TLK_MDI_BTHID_ENABLE         (0 && TLK_STK_BTP_ENABLE)
#endif
#ifndef TLK_MDI_BTHFP_ENABLE
#define TLK_MDI_BTHFP_ENABLE         (0 && TLK_STK_BTP_ENABLE)
#endif
#ifndef TLK_MDI_BTIAP_ENABLE
#define TLK_MDI_BTIAP_ENABLE         (0 && TLK_STK_BTP_ENABLE)
#endif
#ifndef TLK_MDI_BTA2DP_ENABLE
#define TLK_MDI_BTA2DP_ENABLE        (0 && TLK_STK_BTP_ENABLE)
#endif
#ifndef TLK_MDI_BTSCO_ENABLE
#define TLK_MDI_BTSCO_ENABLE         (0 && TLK_STK_BTP_ENABLE)
#endif
...
#define TLK_MDI_AUDIO_ENABLE         (0 && TLK_CFG_MDI_ENABLE)
#endif
...
#define TLK_MDI_MP3_ENABLE           (0 && TLK_CFG_FS_ENABLE)
#endif
#ifndef TLK_MDI_GUI_ENABLE
#define TLK_MDI_GUI_ENABLE           (0 && TLK_CFG_GUI_ENABLE)
#endif
#ifndef TLK_MDI_MSC_ENABLE
#define TLK_MDI_MSC_ENABLE           (0 && TLK_CFG_USB_ENABLE)
#endif
#ifndef TLK_MDI_FS_ENABLE
#define TLK_MDI_FS_ENABLE            (0 && TLK_CFG_FS_ENABLE)
#endif
#ifndef TLK_MDI_AUDPLAY_ENABLE
#define TLK_MDI_AUDPLAY_ENABLE       (0 && TLK_MDI_AUDIO_ENABLE && TLK_MDI_MP3_ENABLE)
#endif
#ifndef TLK_MDI_AUDTONE_ENABLE
#define TLK_MDI_AUDTONE_ENABLE       (0 && TLK_MDI_AUDIO_ENABLE)
#endif
#ifndef TLK_MDI_AUDSRC_ENABLE
#define TLK_MDI_AUDSRC_ENABLE        (0 && TLK_MDI_AUDIO_ENABLE && TLK_MDI_MP3_ENABLE)
#endif
#ifndef TLK_MDI_AUDSNK_ENABLE
#define TLK_MDI_AUDSNK_ENABLE        (0 && TLK_MDI_AUDIO_ENABLE && TLK_STK_BT_ENABLE)
#endif
#ifndef TLK_MDI_AUDSCO_ENABLE
#define TLK_MDI_AUDSCO_ENABLE        (0 && TLK_MDI_AUDIO_ENABLE && TLK_STK_BT_ENABLE)
#endif
#ifndef TLK_MDI_AUDHFP_ENABLE
#define TLK_MDI_AUDHFP_ENABLE        (0 && TLK_MDI_AUDIO_ENABLE && TLK_STK_BT_ENABLE)
#endif
#ifndef TLK_MDI_AUDUAC_ENABLE
#define TLK_MDI_AUDUAC_ENABLE        (0 && TLK_MDI_AUDIO_ENABLE && TLK_USB_UAC_ENABLE)
#endif
...
#define TLK_MDI_MULTIPNT_ENABLE		 (0 && TLK_MDI_BTSCO_ENABLE)
#endif
/******************************************************************************
...
#define TLKMMI_PHONE_ENABLE          (0 && TLK_STK_BTH_ENABLE && TLK_CFG_MMI_ENABLE)
#endif
...
//USER DEFINED FLASH AREA
#define TLK_CFG_FLASH_USER_DATA_ADDR     0xC8000
#define TLK_CFG_FLASH_USER_DATA_SIZE     (1*1024)
